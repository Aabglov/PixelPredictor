...
try:
    ...
    w_h = init_weights((4,100))
    w_h2 = init_weights((100, 3))
...
params = [w_h, w_h2]
updates = RMSprop(cost, params, lr=0.000001)
...
def getTrCoords(i,j,k,pred=None):
    ...
    if pred:
        d = 1
    coords.append(trX[i+d,j,k])
    coords.append(trX[i,j+d,k])
    coords.append(trX[i+d,j+d,k])
...
imsave('/Users/keganrabil/Desktop/Theano/kp_4_from_3.jpg',new_image)
